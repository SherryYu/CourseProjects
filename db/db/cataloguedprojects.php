...
if (isset($_SERVER["QUERY_STRING"])) {
    $catname = explode("=", $_SERVER["QUERY_STRING"])[1];
    if(isExistCatname($mysqli, $catname)) {
        $catres = getCataloguedProjects($mysqli, $catname);
                                            ...
                                            <div class="col-lg-12">
                                                <div class="profile-block">
                                                    <div class="cs-profile-area">
                                                        <div class="cs-title">
                                                            <h4>PROJECTS WITH CATALOGUE <?php echo $catname;?></h4>
                                                        </div>
                                                            ...
                                                            <div class="cs-table-holder">
                                                                <table>
                                                                    ...
                                                                    foreach ($catres as $val) {
                                                                        list($catpid, $catpname, $min,$cur,$posttime,$pstat) = $val;
                                                                        echo "<tr><td>" . $i. "</td>";
                                                                        echo "<td><a href='projectdetail.php?id=".$catpid."'>".$catpname ."</a></td>";
                                                                        echo "<td>" . $cur . "</td>";
                                                                        echo "<td>" . $min . "</td>";
                                                                        echo "<td>" . $posttime . "</td>";
                                                                        echo "<td>" . $pstat . "</td></tr>";
